...
<@layout.mainLayout active='account' bodyClass='user'; section>
    ...
    <form action="${url.accountUrl}" class="form-horizontal" method="post">
        ...
        <p>To delete your account, please email us at <a href="mailto:info@europeana.eu?subject=Delete%20account%20request&body=Please%20remove%20my%20account%20from%20Europeana">info@europeana.eu</a>
