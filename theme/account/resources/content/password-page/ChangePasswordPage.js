// Page based on ./signingin-page/SigningInPage
...
class ChangePasswordPage extends React.Component {
  ...
  renderCategories() {
    return React.createElement(React.Fragment, null, ' ', Array.from(this.state.credentialContainers.keys()).map(category => React.createElement(StackItem, {
      key: category,
      isFilled: true
    }, React.createElement(Title, React.createElement('strong', null, React.createElement(Msg, {
      msgKey: category
  ...
  renderUserCredentials(credTypeMap, credType, keycloak) {
    ...
    return React.createElement(React.Fragment, {
      ...
      id: `${ChangePasswordPage.credElementId(type, credential.id, 'row')}`,
  ...
  credentialRowCells(credential, type) {
    ...
    credRowCells.push(React.createElement(DataListCell, {
      id: `${ChangePasswordPage.credElementId(type, credential.id, 'label')}`,
      key: 'userLabel-' + credential.id
    }, credential.userLabel));

    if (credential.strCreatedDate) {
      credRowCells.push(React.createElement(DataListCell, {
        id: `${ChangePasswordPage.credElementId(type, credential.id, 'created-at')}`,
...
_defineProperty(ChangePasswordPage, 'contextType', AccountServiceContext);
  ...
  render() {
    if (this.props.updateAction) {
      return React.createElement(ActionGroup, null, React.createElement(Button, {
        ...
        id: `${ChangePasswordPage.credElementId(this.props.credential.type, this.props.credential.id, 'update')}`,
        variant: 'primary',
    ...
    if (this.props.removeable) {
      ...
      return React.createElement(DataListAction, {
        ...
        buttonTitle: 'remove',
        buttonId: `${ChangePasswordPage.credElementId(this.props.credential.type, this.props.credential.id, 'remove')}`,
...
export { ChangePasswordPageWithRouter as ChangePasswordPage };
